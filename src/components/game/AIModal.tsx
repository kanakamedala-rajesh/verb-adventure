        ...
        >
          ...
          >
            ...
            <div className="flex justify-between items-center mb-4 sm:mb-6 shrink-0 pt-2 sm:pt-0">
              <h3
                id="modal-title"
                className="text-xl sm:text-2xl font-heading text-purple-600 uppercase flex items-center gap-2 sm:gap-3"
              >
                <Sparkles
              ...
              {isOffline ? (
                <div className="flex flex-col items-center gap-4 sm:gap-6 text-slate-500 py-4">
                  ...
                  <div className="text-center space-y-2">
                    <p className="font-heading text-lg text-slate-700 uppercase">
                      Magic is Sleeping!
                    </p>
                    <p className="text-sm font-body font-bold leading-relaxed px-2">
                      The Wizard needs the internet to cast new spells. Please connect to see the
                      trick!
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center gap-3 sm:gap-4 text-purple-500">
                  <Loader2
                    className="animate-spin sm:w-12 sm:h-12"
                    size={32}
                    strokeWidth={3}
                    aria-hidden="true"
                  />
                  <span className="font-heading text-base sm:text-lg animate-pulse text-center uppercase tracking-wide">
                    Thinking...
                  </span>
                </div>
              ) : (
